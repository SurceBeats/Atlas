...
A few kbs approximately? Anyway, if all the image files generated by "The Atlas" during runtime were saved (which it's not the case), the storage requirements would be astronomical:
